...
import StoreSwitcher from '@/components/restaurateur/StoreSwitcher'
import {
  Store,
  UtensilsCrossed,
  ClipboardList,
...
const menuItems = [
  {
    ...
    roles: ['RESTAURATEUR', 'MANAGER', 'STORE_MANAGER', 'SUPER_ADMIN'],
    subItems: [
      { name: 'Analyses locales', href: '/backoffice/analytics', icon: <TrendingUp />, roles: ['RESTAURATEUR', 'MANAGER', 'STORE_MANAGER'] },
      { name: 'Consolidation', href: '/backoffice/consolidated', icon: <Layers />, roles: ['RESTAURATEUR', 'MANAGER', 'STORE_MANAGER', 'SUPER_ADMIN'] }
    ]
  },
  {
    name: 'Console Franchise',
    icon: <Building />,
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: 'Transferts inter-sites', href: '/backoffice/stock-transfers', icon: <Truck />, roles: ['RESTAURATEUR', 'MANAGER', 'STORE_MANAGER', 'SUPER_ADMIN'] },
  ...
  { name: 'Réservations', icon: <Calendar />, href: '/backoffice/booking', roles: ['RESTAURATEUR', 'MANAGER'] },
  ...
  { name: 'Fidélité', icon: <Gift className="h-4 w-4 shrink-0" />, href: '/backoffice/loyalty', roles: ['RESTAURATEUR', 'MANAGER', 'CASHIER'] },
