// src/components/pos/subcomponents/payment-modal/PaymentMobilePanel.tsx
'use client'
...
export function PaymentMobilePanel({
  amountReceived,
  onClear,
  selectedBills = [],
  onAddBill,
      ...
      {!useFallback ? (
        ...
        <div className="space-y-4 animate-in fade-in zoom-in-95 duration-300">
          <div className="flex justify-between items-center">
            <span className="text-[9.5px] font-black uppercase tracking-[0.25em] text-[#e03131]">Alternative : Saisie Billets</span>
            <button
              onClick={() => {
          ...
          <div className="bg-[#1A1D20] rounded-2xl p-4 shadow-xl relative overflow-hidden transition-all border border-white/5">
            <div className="flex justify-between items-center mb-1">
              <span className="text-[9px] font-black text-white/40 uppercase tracking-[0.25em]">Montant Reçu (Mobile Alternative)</span>
              {numericAmount > 0 && (
                <button
                  onClick={() => {
                    onClear()
